...
@Module({
  imports: [AuthModule, BillingModule, ClinicsModule, HealthModule, QrModule, RbacModule, SettingsModule, TechnicianAssignmentsModule, UsersModule, WorkTypesModule, WorkFormsModule, WorkflowTemplatesModule, WorksModule],
})
