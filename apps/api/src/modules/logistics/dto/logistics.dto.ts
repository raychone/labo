...
const LOGISTICS_CENTER_CATEGORIES = ["ALL", "INTRARI_ASTAZI", "DE_VERIFICAT", "IN_PRODUCTIE", "NEASIGNATE", "BLOCARE", "URGENTE", "INTARZIATE", "FINALIZATE_AZI", "DE_AMBALAT", "IN_AMBALARE", "GATA_DE_LIVRARE", "NEFACTURATE", "IN_ASTEPTARE", "DE_LIVRAT", "DE_RIDICAT"] as const;
