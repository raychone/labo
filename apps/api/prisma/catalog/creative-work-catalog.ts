...
export const CREATIVE_WORK_CATALOG: readonly CreativeWorkCatalogEntry[] = [
  ...
  entry("mc-fizionomic", "Coroană metalo-ceramică total fizionomică", "ELEMENT", 320, "MC", gingie),
  entry("placata-4-plus", "Coroane adiacente placate cu ceramică (4+)", "ELEMENT", 50, "LA_GATA", none),
  entry("gingie-ceramica-compozit", "Reproducere țesut gingival ceramică-compozit", "ELEMENT", 200, "LA_GATA", none),
