...
export const POSTMEETING_AUDIT_ACTIONS = {
  ...
  maneuverPricingUnitChanged: "technician.maneuver_pricing_unit_changed",
...
export const POSTMEETING_AUDIT_ACTION_LABELS_RO: Readonly<Record<PostmeetingAuditAction, string>> = {
  ...
  [POSTMEETING_AUDIT_ACTIONS.maneuverPricingUnitChanged]: "Unitatea de plată a manoperei a fost modificată.",
