...
export const OPERATIONAL_STATUS_LOGISTICS_STATUSES = ["RECEIVED", "IN_PRODUCTION", "BLOCKED", "HANDED_TO_DELIVERY", "DELIVERED"] as const;
...
export const OPERATIONAL_STATUS_LEGAL_ENTITY_CODES = ["CDT", "NG"] as const;
export const OPERATIONAL_STATUS_REAL_LAB_SHEET_STATUSES = ["NOT_STARTED", "IN_PROGRESS", "COMPLETE", "FINALIZED"] as const;
