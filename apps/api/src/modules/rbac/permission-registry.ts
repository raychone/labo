...
export const PERMISSION_REGISTRY = [
  ...
  definePermission("routes.execute_own", "Start routes and record outcomes on assigned route stops."),
...
export const ROLE_PERMISSION_MATRIX = {
  ...
  LOGISTICA: grants({
    ...
    "routes.create": "ALL",
    "routes.execute_own": "ALL",
    "routes.read": "ALL",
    "routes.update": "ALL",
    "scan.resolve": "ALL",
    "scan.use": "ALL",
    "workflow.complete_stage": "ALL",
    "workflow.read": "ALL",
    "workflow.start_stage": "ALL",
    "works.assign": "ALL",
    ...
    "works.technical_details.update": "ALL",
    "works.update": "ALL",
  ...
  TEHNICIAN: grants({
    ...
    "works.custom_type.save_to_catalog": "ALL",
    "works.custom_platform.save_to_catalog": "ALL",
    "works.connections.manage": "ASSIGNED",
    "works.item.create": "ASSIGNED",
    "works.item.remove": "ASSIGNED",
    "works.item.update": "ASSIGNED",
    "works.scope.update": "ASSIGNED",
    "works.update": "ASSIGNED",
    "workflow.complete_stage": "OWN_STAGE",
